  ...
  return (
    <div>
      <div className="flex flex-col md:flex-row bg-black text-white md:px-12">
        <div className="font-bold text-3xl  w-[70vw] md:w-[20vw] text-center mx-auto m-7">
          Trxvl.
        </div>
        <div className="text-shade">
          <div className="flex flex-col md:flex-row ">
            <div className="flex flex-col items-start  mx-auto w-[70vw] md:w-[20vw]  md:m-7  gap-3">
              ...
              <div>Gillie</div>
              <div>Size Last</div>
              <div className="border border-shade w-32 p-2  text-center">
                Helmet KOD
              </div>
            </div>
          ...
          <div className=" flex justify-center md:justify-start md:ml-20 my-7 text-center ">
